...
import { X, Loader2, Eye, Bold, Italic, Heading, List, BookOpen, Users, Hash, Percent, ImagePlus, Link as LinkIcon, Upload, Radio, Star, Tag, Circle, ArrowRight } from 'lucide-react';
              ...
              <div className="px-4 sm:px-6 py-5 space-y-5">
                ...
                {currentStepId === "basic" && (
                  <div className="space-y-5 animate-fade-in">
                    ...
                    {/* 공급가 / 중간관리자 마진 — 브랜드/관리자 전용 (고객 비공개). 수수료 제공 방식에서는 숨김 */}
                    {showSupplyFields && priceModel === "SUPPLY" && (
                      <div className="border border-gray-200 rounded-xl p-4 space-y-3.5 bg-gray-50/50">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-[10px] text-gray-400">권한자 전용 · 고객 비공개</span>
                        </div>
